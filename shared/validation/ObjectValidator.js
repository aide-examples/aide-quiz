 ...
 * Works on server (Node.js) and client (browser) (Browser)
 */
...
class ObjectValidator {
   ...
   * @param {string} entityType - Name of the entity type (e.g. 'Quiz')
  ...
  _validatePattern(fieldName, value, pattern) {
    ...
    if (!regex.test(value)) {
      return {
        ...
        message: `Field "${fieldName}" contains invalid characters`,
        value
      };
    }
